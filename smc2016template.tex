...
\begin{figure}
	...
	\caption{Example and temporal syntax for i-score. 
...
The graph, implemented with the Boost.Graph\todo{CITE} library can then be used to 
...
\begin{figure}
	...
	\caption{Translation of the Time Constraint of fig.~\ref{fig.iscoreconstraint} in a graph.
		...
		the Constraint. The percentages represent the level of mixing of the stream in the return.}
	\label{fig.graph}
\end{figure}
...
\todo{Dire qu'on mixe avant de rentrer dans une chaine d'effets}
